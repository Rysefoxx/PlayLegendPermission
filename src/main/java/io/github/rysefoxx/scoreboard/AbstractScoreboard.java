...
public abstract class AbstractScoreboard {
     ...
     * @param languageManager The {@link LanguageManager} to translate the lines.
     * @return The lines of the scoreboard.
     */
    public abstract HashMap<String, ScoreboardEntry> getLines(@NotNull Player player, @NotNull LanguageManager languageManager);
}
